...
def start_game():
    ...
    while run:
        ...
        window.blit(ninja('ninja/sasori.png'), (ninja_move_y(400), ninja_move_x(700)))
        window.blit(ninja('ninja/sasori.png'), (ninja_move_y(800), ninja_move_x(750)))
        window.blit(ninja('ninja/sasori.png'), (ninja_move_y(1200), ninja_move_x(700)))
